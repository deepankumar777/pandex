...
abstract contract LiquidityManagement is IPancakeV3MintCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    address public factory1 = 0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9;
        ...
        )
    {
        ...
        console.log("computed pool", address(pool));
        // compute the liquidity amount
        {
            (uint160 sqrtPriceX96, , , , , , ) = pool.slot0();
            console.log("SQP",sqrtPriceX96);
            console.log("aa");
            uint160 sqrtRatioAX96 = TickMath.getSqrtRatioAtTick(params.tickLower);
            uint160 sqrtRatioBX96 = TickMath.getSqrtRatioAtTick(params.tickUpper);
            console.log("SQA",sqrtRatioAX96);
            console.log("SQB",sqrtRatioBX96);
